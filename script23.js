...
this.checkUnread(userId, unreadDot);
   ...
   this.loadUsers(); // Refresh the user list to update red dot
    ...
    if (index === 0) {
        console.log("Ã°Å¸â€œÅ’ First message:", message.message);
...
renderMessageContent(content) {
    ...
    try {
        ...
        console.warn("Ã¢Å¡ Ã¯Â¸Â URL parsing failed:", e);
    }
    ...
    try {
        ...
        this.showToast('Ã¢Å“â€¦ Email sent successfully!', 'success');
        this.closeEmailModal();

    } catch (error) {
        console.error('Ã¢ÂÅ’ Email send failed:', error);
